...
import { faGift, faPercent, faConciergeBell, faCalendarCheck, faCheck,faMap, faPhoneAlt,faBlackTie, faPlaneDeparture, faCreditCard,faClocK,faMapMarkedAlt } from '@fortawesome/free-solid-svg-icons';
...
{/* Image on the right */}
<div className="mb-4">
<FontAwesomeIcon icon={faClocK} className="text-black text-3xl" />
</div>
{/* Text on the left */}
<div className="text-left text-black">
